function Footer() {
    return (
        <footer className="footer  bg-[#02245B] border-t-2 text-gray-300 p-10">
                <aside>
                {/* <svg
                    width="50"
                    height="50"
                ...
                <nav>
                <h6 className="text-slate-50 footer-title">Company</h6>
                ...
                <nav>
                <h6 className="text-slate-50 footer-title">Legal</h6>
